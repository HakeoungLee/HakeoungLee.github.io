...
title:  "한국 여권에 영문 성명 넣기 (영문 성명 병기 표기하는 방법)"
---
...
두 번째, 앞으로 논문을 publish할 때 내가 Hannah라는 이름을 베이스로 활동했기 때문에 Hannah라는 이름을 넣게 되면 추후 영주권 심사에서 여러 귀찮은 상황이 발생할 수 있다. 일례로 Hannah라는 이름을 사용하여 논문을 publish했지만 본인이 직접 작성한 논문이 맞음에도 공식적인 이름이 아니기에 실적으로 인정받지 못할 수도 있다는 점이다. 앞으로의 귀찮은 상황을 방지하기 위해 여권에 영문 표기를 결정했다.   
